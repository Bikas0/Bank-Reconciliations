...
BATCH_SIZE = 16  # RTX A5000 can handle 12-16 images simultaneously (PUSHING LIMITS)
...
MAX_TOKENS = 4096  # Minimum tokens for maximum speed (quality vs speed trade-off)
...
MAX_GPU_MEMORY = "23GB"  # RTX A5000 has 24GB, use 22GB (90%+ utilization)
